...
This project presents a modular cabinet and shelf system designed in Autodesk Inventor. The concept is based on interchangeable storage modules that can be combined in different configurations to create customized furniture layouts.
